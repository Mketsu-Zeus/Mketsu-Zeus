# ⚡ Thabo .L Mketsu | Zeus Bhose

<div style="background: #0a0a0a; color: #00ff00; font-family: 'Courier New', monospace; padding: 25px; border-radius: 8px; border: 1px solid rgba(0,255,0,0.2);">

<div style="text-align: center; margin-bottom: 20px;">
  <pre style="color:#00ff00; background:transparent; border:none; font-family:'Courier New',monospace; line-height:1.8;">
╔════════════════════════════════════════════════╗
║  ssh thabo@bhose-elangani.dev                  ║
║  Creative Tech × Full‑Stack × Entrepreneur     ║
